...
class acceptAppointmentClient extends StatefulWidget {
  const acceptAppointmentClient({super.key});

  @override
  State<acceptAppointmentClient> createState() =>
      _acceptAppointmentClientState();
}

class _acceptAppointmentClientState extends State<acceptAppointmentClient> {
              ...
              SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return apointmentsClients[index].status == 'Accepter'
                          ? Padding(
